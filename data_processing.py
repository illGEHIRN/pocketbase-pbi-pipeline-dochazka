...
attendance_cols = [
    "id", "user_id", "date", "type", "note", "status_flag", "from", "to",
    "hours_worked", "hours_paused", "lunch", "manual", "wage"
]
...
# export to csv
df_dim_users.to_csv("CSVs/dim_users.csv", index=False, encoding="utf-8-sig")
df_attendance.to_csv("CSVs/fact_attendance.csv", index=False, encoding="utf-8-sig")
